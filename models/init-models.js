...
var _mdl_badge_backpack_oauth2 = require("./mdl_badge_backpack_oauth2");
...
var _mdl_contentbank_content = require("./mdl_contentbank_content");
...
var _mdl_h5pactivity = require("./mdl_h5pactivity");
var _mdl_h5pactivity_attempts = require("./mdl_h5pactivity_attempts");
var _mdl_h5pactivity_attempts_results = require("./mdl_h5pactivity_attempts_results");
var _mdl_imscp = require("./mdl_imscp");
var _mdl_infected_files = require("./mdl_infected_files");
...
var _mdl_oauth2_refresh_token = require("./mdl_oauth2_refresh_token");
...
var _mdl_paygw_paypal = require("./mdl_paygw_paypal");
var _mdl_payment_accounts = require("./mdl_payment_accounts");
var _mdl_payment_gateways = require("./mdl_payment_gateways");
var _mdl_payments = require("./mdl_payments");
...
var _mdl_tool_brickfield_areas = require("./mdl_tool_brickfield_areas");
var _mdl_tool_brickfield_cache_acts = require("./mdl_tool_brickfield_cache_acts");
var _mdl_tool_brickfield_cache_check = require("./mdl_tool_brickfield_cache_check");
var _mdl_tool_brickfield_checks = require("./mdl_tool_brickfield_checks");
var _mdl_tool_brickfield_content = require("./mdl_tool_brickfield_content");
var _mdl_tool_brickfield_errors = require("./mdl_tool_brickfield_errors");
var _mdl_tool_brickfield_process = require("./mdl_tool_brickfield_process");
var _mdl_tool_brickfield_results = require("./mdl_tool_brickfield_results");
var _mdl_tool_brickfield_schedule = require("./mdl_tool_brickfield_schedule");
var _mdl_tool_brickfield_summary = require("./mdl_tool_brickfield_summary");
...
function initModels(sequelize) {
  ...
  var mdl_badge_backpack_oauth2 = _mdl_badge_backpack_oauth2(sequelize, DataTypes);
  ...
  var mdl_contentbank_content = _mdl_contentbank_content(sequelize, DataTypes);
  ...
  var mdl_h5pactivity = _mdl_h5pactivity(sequelize, DataTypes);
  var mdl_h5pactivity_attempts = _mdl_h5pactivity_attempts(sequelize, DataTypes);
  var mdl_h5pactivity_attempts_results = _mdl_h5pactivity_attempts_results(sequelize, DataTypes);
  var mdl_imscp = _mdl_imscp(sequelize, DataTypes);
  var mdl_infected_files = _mdl_infected_files(sequelize, DataTypes);
  ...
  var mdl_oauth2_refresh_token = _mdl_oauth2_refresh_token(sequelize, DataTypes);
  ...
  var mdl_paygw_paypal = _mdl_paygw_paypal(sequelize, DataTypes);
  var mdl_payment_accounts = _mdl_payment_accounts(sequelize, DataTypes);
  var mdl_payment_gateways = _mdl_payment_gateways(sequelize, DataTypes);
  var mdl_payments = _mdl_payments(sequelize, DataTypes);
  ...
  var mdl_tool_brickfield_areas = _mdl_tool_brickfield_areas(sequelize, DataTypes);
  var mdl_tool_brickfield_cache_acts = _mdl_tool_brickfield_cache_acts(sequelize, DataTypes);
  var mdl_tool_brickfield_cache_check = _mdl_tool_brickfield_cache_check(sequelize, DataTypes);
  var mdl_tool_brickfield_checks = _mdl_tool_brickfield_checks(sequelize, DataTypes);
  var mdl_tool_brickfield_content = _mdl_tool_brickfield_content(sequelize, DataTypes);
  var mdl_tool_brickfield_errors = _mdl_tool_brickfield_errors(sequelize, DataTypes);
  var mdl_tool_brickfield_process = _mdl_tool_brickfield_process(sequelize, DataTypes);
  var mdl_tool_brickfield_results = _mdl_tool_brickfield_results(sequelize, DataTypes);
  var mdl_tool_brickfield_schedule = _mdl_tool_brickfield_schedule(sequelize, DataTypes);
  var mdl_tool_brickfield_summary = _mdl_tool_brickfield_summary(sequelize, DataTypes);
